        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Unit = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    WeightPerUnit = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityWeight = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InboundRecords_ProductInformations_ProductInformationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stock_ProductInformations_ProductInformationId",
                        column: x => x.ProductInformationId,
                        principalTable: "ProductInformations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DriverPhoneNumber = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedWeight = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    ManufactureDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    DefectiveUnits = table.Column<int>(type: "int", nullable: false),
                    DefectiveWeight = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    ReplacedUnits = table.Column<int>(type: "int", nullable: false),
                    ReplacedWeight = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderLineDetails_Lines_LineId",
                        column: x => x.LineId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderDetailId = table.Column<int>(type: "int", nullable: false),
                    LineId = table.Column<int>(type: "int", nullable: false),
                    SensorUnits = table.Column<int>(type: "int", nullable: false),
                    SensorWeight = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SensorRecords_Lines_LineId",
                        column: x => x.LineId,
                        principalTable: "Lines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SensorRecords_OrderDetails_OrderDetailId",
                        column: x => x.OrderDetailId,
                        principalTable: "OrderDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SensorRecords_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "43aade12-2d07-4ac3-995d-ab3a12b40e6c", null, new DateTime(2015, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "UserRole", "Admin", "ADMIN" },
                    { "58b29810-3133-4c2a-93c0-b3973fdf092b", null, new DateTime(2015, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "UserRole", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "92db8399-e34b-4bda-9e95-21cdc39c11fa", 0, "c991e4d0-b6c1-439c-9718-a5544257e5ee", "user002@matech.com", false, "UserFirstName", "UserLastName", false, null, null, null, "AQAAAAIAAYagAAAAEABXbthPhGxmiNewiDD8D1UzqHrcEEpeEf+SijEJRI9YFW0tfwZBOQT0PNBzsV2osA==", null, false, "e640b02a-ab5e-4379-99f9-7fd6459b6a47", false, "user002" },
                    { "dbeb0889-5348-489e-a611-ec710841d0fa", 0, "9a71e9a6-337c-4b2b-85fc-777d98b0644c", "admin001@matech.com", false, "AdminFirstName", "AdminLastName", false, null, null, null, "AQAAAAIAAYagAAAAEKJVYwcpG/7RfQD1tsrpvDZ57DSmYTiIJW2Nb5LmAVjuybSecD1IH+e54vDqpWr0oQ==", null, false, "4583f5f8-a8fd-4458-b399-76c7242d254e", false, "admin001" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InboundRecords_ProductInformationId",
                table: "InboundRecords",
                column: "ProductInformationId");

            migrationBuilder.CreateIndex(
                name: "IX_Lines_LineNumber",
                table: "Lines",
                column: "LineNumber",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderLineDetails_LineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SensorRecords_LineId",
                table: "SensorRecords",
                column: "LineId");

            migrationBuilder.CreateIndex(
                name: "IX_SensorRecords_OrderDetailId",
                table: "SensorRecords",
                column: "OrderDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_SensorRecords_OrderId",
                table: "SensorRecords",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_Stock_ProductInformationId",
                table: "Stock",
                column: "ProductInformationId",
                unique: true);
